...
% constant terms for eqns of motion must be defined before simulating
m = 2;
k = 10;
bar_x1 = 0.5;
...
% time discretization, length of simulation, etc., also set before starting
...
% Store the initial conditions as the first column for ease of use.
x_traj = zeros(2, n_timesteps+1);
% ...remember that matlab counts from 1, but our first datapoint is time 0.
x_traj(1,1) = x1_0;
x_traj(2,1) = dotx1_0;
...
for t=1:n_timesteps
    ...
    % dynamics update via forward integration

function [bolddotx] = f_Q5b(x, constants)
...
%   differential equation given in ME 501 HW1 Q5a-b, representing a
%   point mass moving horizontally with a spring attached.
%
%   Inputs:
%       x == state at time t
...
bolddotx = [x(2); -(constants.k/constants.m)*(x(1) - constants.bar_x1)];
